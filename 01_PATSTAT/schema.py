...
class Schema:
    """
    Contains the schema of PatStat2018b tables
    
    Credits:   The initial version of this class is taken from the OpenPatstat project, which were written for PATSTAT v2016a (Link to GitHub: https://github.com/cverluise/openPatstat)
    """
